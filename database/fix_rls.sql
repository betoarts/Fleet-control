-- ============================================
-- NBAPARK Fleet Control - Supabase Cloud RLS Fix
...
-- 2. Remover políticas existentes para evitar conflitos (opcional)
-- DROP POLICY IF EXISTS "Permitir tudo para anon" ON public.users;
-- ... (repetir para outras tabelas se necessário)

-- 3. Criar Políticas Permissivas para o papel 'anon' 
-- (Como o app usa um sistema de login próprio via telefone, as requisições chegam como 'anon')
